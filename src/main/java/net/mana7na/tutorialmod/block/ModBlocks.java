package net.mana7na.tutorialmod.block;
...
public class ModBlocks {
    public static final Block PINK_GARNET_BLOCK = registerBlock("pink_garnet_block",
            new Block(AbstractBlock.Settings.create().strength(4f)
                    ...
                    // ツールで採掘可能にしたり、音を呼び出したりできる
                    // shift 2回で include non-project item をチェック、blocksで検索するとnet.minecraft blocks ...一番上に出るやつで色々見れる
    ...
    public static final Block PINK_GARNET_BUTTON = registerBlock("pink_garnet_button",
            new ButtonBlock(BlockSetType.IRON,2, AbstractBlock.Settings.create().strength(2f).requiresTool()));
