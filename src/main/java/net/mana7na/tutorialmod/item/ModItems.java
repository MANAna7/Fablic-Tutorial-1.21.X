package net.mana7na.tutorialmod.item;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.mana7na.tutorialmod.TutorialMod;
import net.mana7na.tutorialmod.item.custom.ChiselItem;
import net.mana7na.tutorialmod.item.custom.HammerItem;
...
public class ModItems {
    ...
    public static final Item CHISEL = registerItem("chisel",new ChiselItem(new Item.Settings().maxDamage(12)));
